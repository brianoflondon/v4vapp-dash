...
class WalletDisabled(DashdError):
    """dashd was started with -disablewallet=1 (yoga IBD image)."""
...
class Dashd:
    """JSON-RPC client. Node methods hit DASH_RPC_URL; wallet methods hit /wallet/<name>."""
    ...
    async def _call(self, url: str, method: str, params: list[Any]) -> Any:
        payload = {"jsonrpc": "1.0", "id": "v4vapp-dash", "method": method, "params": params}
